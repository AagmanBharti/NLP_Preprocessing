...
st.write("Tokenization, Text Cleaning, Stemming, Lemmatizer, and Bag of Words")

# User Input
text = st.text_area("Enter Text for NLP Preprocessing",height = 150,
                    placeholder="Example: Aman is the HOD of CSE and loves NLP")  
...
if st.button("Process Text"):
    ...
    # Bag of Words
        ...
        st.markdown("### Word Frequency Distribution (Top 10 Words)")
